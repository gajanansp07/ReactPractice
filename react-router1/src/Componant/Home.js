...
const Home=()=>{
    return(<div>
        ...
        React Router
------------------
Routing is a process in which a user is directed to different pages based 
on their action or request. 
ReactJS Router is mainly used for developing 
...
-----------------------------
React Router plays an important role to display 
...
react-router: It provides the core routing components and functions 
for the React Router applications.
